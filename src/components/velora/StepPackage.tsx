...
const combos = [
  {
    ...
    label: "Essencial",
    price: 97,
    description: "3 fotos editoriais com modelo IA · Direção de arte básica · Entrega em até 48h úteis",
  },
  {
    photos: 5,
    videos: 2,
    label: "Impacto",
    price: 247,
    description: "5 fotos editoriais + 2 vídeos curtos (reels/stories) · Direção de arte personalizada · Entrega em até 48h úteis",
    popular: true,
  },
  {
    photos: 10,
    ...
    price: 497,
    description: "10 fotos editoriais + 5 vídeos curtos · Direção criativa completa com moodboard · Prioridade na entrega (24-48h)",
  },
];
    ...
    >
      <div className="text-center space-y-3">
        ...
        <p className="text-muted-foreground font-body text-xs tracking-wider uppercase">
          Pacotes prontos ou personalize a quantidade
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-3">
        {combos.map((combo, i) => (
          <motion.button
            ...
            className={`p-5 rounded-lg border text-left relative transition-all duration-300 ${
          ...
          >
            ...
            <div className="flex items-baseline justify-between gap-3">
              ...
              <p className="text-2xl font-display font-semibold text-primary whitespace-nowrap">
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-muted-foreground tracking-wider">({formatPrice(PHOTO_PRICE)}/und)</span>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-muted-foreground tracking-wider">({formatPrice(VIDEO_PRICE)}/und)</span>
            </div>
            <div className="flex items-center gap-3">
              <button
