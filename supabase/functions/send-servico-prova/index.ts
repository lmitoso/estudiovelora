...
<html lang="pt-BR">
  <head>
    ...
    <title>O que muda quando a imagem é criada com direção</title>
  </head>
  <body style="margin:0;padding:0;background:#fafaf7;font-family:Raleway,Arial,sans-serif;color:#1a1a1a;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;visibility:hidden;mso-hide:all;">
      A diferença não está na ferramenta. Está na decisão criativa.
    </div>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#fafaf7;">
          ...
          <tr><td style="padding:0 24px;">
            <p style="font-family:Georgia,'Cormorant Garamond',serif;font-weight:700;font-size:18px;line-height:1.8;color:#1a1a1a;margin:0 0 16px;">
              Foto de produto e campanha editorial não são a mesma coisa.
            </p>
            <p style="font-family:Raleway,Arial,sans-serif;font-size:16px;line-height:1.8;color:#1a1a1a;margin:0 0 16px;">
              Foto de produto mostra o item — fundo neutro, ângulo limpo, função catalogal. Tem seu lugar. Mas vende o item, não a marca.
            </p>
            <p style="font-family:Raleway,Arial,sans-serif;font-size:16px;line-height:1.8;color:#1a1a1a;margin:0;">
              Campanha editorial vende um universo. Atmosfera, contexto, desejo. É o que faz o cliente lembrar da marca antes do produto — e pagar mais por isso.
            </p>
          </td></tr>
          ...
          <tr><td style="padding:0 24px;">
            <p style="font-family:Georgia,'Cormorant Garamond',serif;font-weight:700;font-size:18px;line-height:1.8;color:#1a1a1a;margin:0 0 16px;">
              Como começamos no estúdio.
            </p>
            <p style="font-family:Raleway,Arial,sans-serif;font-size:16px;line-height:1.8;color:#1a1a1a;margin:0 0 16px;">
              Nenhum projeto começa com prompt. Começa com briefing criativo: quem é a marca, o que ela quer comunicar, qual sensação queremos provocar, qual referência visual traduz isso.
            </p>
            <p style="font-family:Raleway,Arial,sans-serif;font-size:16px;line-height:1.8;color:#1a1a1a;margin:0;">
              Só depois disso a IA entra — como meio de execução, não como ponto de partida.
            </p>
          </td></tr>
          ...
          <tr><td style="padding:0 24px;">
            ...
            <p style="font-family:Raleway,Arial,sans-serif;font-size:16px;line-height:1.8;color:#1a1a1a;margin:0;">
              Identidade visual que se sustenta entre frames. Coerência ao longo de toda a coleção. Intenção em cada decisão de cor, luz e composição. Uma campanha que parece campanha — não um conjunto de imagens soltas.
            </p>
          </td></tr>
          ...
          <tr><td style="padding:0 24px;">
            <p style="font-family:Raleway,Arial,sans-serif;font-size:16px;line-height:1.8;margin:0;">
              <a href="${STUDIO_URL}" style="color:#C9A96E;text-decoration:none;border-bottom:1px solid rgba(201,169,110,0.4);">
                → Conhecer o estúdio e os projetos
              </a>
            </p>
          </td></tr>
...
serve(async (req) => {
  ...
  try {
    ...
    console.error("send-servico-prova error:", error);
