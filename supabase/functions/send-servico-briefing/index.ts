...
<html lang="pt-BR">
  <head>
    ...
    <title>Podemos criar algo para a sua marca?</title>
  </head>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#fafaf7;">
          ...
          <tr><td style="padding:0 24px;">
            ...
            <p style="font-family:Raleway,Arial,sans-serif;font-size:16px;line-height:1.8;color:#1a1a1a;margin:0;">
              Tem algum projeto visual que a sua marca precisa resolver agora?
            </p>
          </td></tr>
          ...
          <tr><td style="padding:0 24px;">
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr><td style="font-family:Raleway,Arial,sans-serif;font-size:16px;line-height:1.8;color:#1a1a1a;padding:0 0 8px 0;">
                <span style="color:#C9A96E;">→</span>&nbsp;Uma coleção nova chegando, sem campanha pronta.
              </td></tr>
              <tr><td style="font-family:Raleway,Arial,sans-serif;font-size:16px;line-height:1.8;color:#1a1a1a;padding:0 0 8px 0;">
                <span style="color:#C9A96E;">→</span>&nbsp;Produto que você sente que está sendo mal fotografado.
              </td></tr>
              <tr><td style="font-family:Raleway,Arial,sans-serif;font-size:16px;line-height:1.8;color:#1a1a1a;padding:0 0 8px 0;">
                <span style="color:#C9A96E;">→</span>&nbsp;Identidade da marca que existe no papel mas ainda não comunica visualmente.
              </td></tr>
              <tr><td style="font-family:Raleway,Arial,sans-serif;font-size:16px;line-height:1.8;color:#1a1a1a;padding:0;">
                <span style="color:#C9A96E;">→</span>&nbsp;Data comemorativa chegando e nada planejado.
              </td></tr>
            </table>
          </td></tr>
          ...
          <tr><td style="padding:0 24px;">
            ...
            <p style="font-family:Raleway,Arial,sans-serif;font-size:16px;line-height:1.8;color:#1a1a1a;margin:0 0 16px;">
              Vinte minutos de briefing. Não é call de vendas. É conversa de entendimento — você conta o desafio, eu mostro como pensaríamos a solução. No fim você sai com clareza, com ou sem proposta.
            </p>
            <p style="font-family:Raleway,Arial,sans-serif;font-size:16px;line-height:1.8;color:#1a1a1a;margin:0;">
              Se fizer sentido, seguimos. Se não, você levou um diagnóstico honesto.
            </p>
          </td></tr>
...
serve(async (req) => {
  ...
  try {
    ...
    const response = await fetch(`${RESEND_API_URL}/emails`, {
      ...
      body: JSON.stringify({
        from: FROM, to: [email],
        subject: "Podemos criar algo para a sua marca?",
